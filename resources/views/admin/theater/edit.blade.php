<!-- Modal -->
<div class="modal fade modal-lg" id="TheaterEditModal" tabindex="-1" aria-labelledby="RoomsModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="exampleModalLabel">Edit Theater</h1>
            ...
            <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="address" type="text" value="{{ $theater->address }}" name="address" placeholder="type
                                address.
                                ..">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="city" type="text" value="{{ $theater->city }}" name="city" placeholder="type
                                city.
                                ..">
                            </div>
                        </div>
                ...
                @include('admin.theater.room.list')
            </div>
