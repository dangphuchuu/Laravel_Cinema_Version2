                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" name="name" class="form-control" placeholder="Name..." value="{{$room->name}}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="type" id="type">
                                        ...
                                        <option value="{{$type->id}}" @if($room->roomType_id == $type->id) selected @endif>
                                            {{$type->name}}
                                        </option>
                                        @endforeach
                                    </select>
                    ...
                    <div class="d-block overflow-x-auto text-center">
                        <div class="w-100 mt-2 my-auto mb-4 text-center justify-content-center">
                            ...
                            <div class="row d-block m-2" style="margin: 2px">
                                <div class="d-inline-block align-middle my-0 mx-1 py-1 px-0 disabled" style="width: 30px; height: 30px; line-height: 22px; font-size: 10px">
                                </div>
                            </div>
                            ...
                            <div class="row d-block" id="Row_{{ $row->row }}" style="margin: 2px">
                                ...
                                @for($m = 0; $m < $seat->ms; $m++)
                                    ...
                                    @endfor
                                    <div class="d-inline-block cursor-pointer align-middle py-1 px-0 seat_enable" id="Seat_{{ $seat->row.$seat->col}}" style="
                                                         @if($seat['status'] == 1)
                                    ...
                                    @for($n = 0; $n < $seat->me; $n++)
                                        ...
                                        @endif
                                        @if($loop->last)
                                        <div class="d-inline-block border cursor-pointer align-middle py-1 px-0" style=" width: 30px; height: 30px; margin: 2px -30px 2px 0;" data-bs-toggle="offcanvas" data-bs-target="#EditRow_{{ $room->id }}_{{ $row->row }}">
