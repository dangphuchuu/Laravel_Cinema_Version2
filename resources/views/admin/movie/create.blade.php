                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <button type="button" class="form-control btn bg-gradient-danger float-right mb-3" data-bs-toggle="modal" data-bs-target="#movie_genre">
                                        @lang('lang.select')
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <select id="casts" class="form-select cast-input form-control" name="casts[]" multiple>
