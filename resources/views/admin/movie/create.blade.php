                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <select id="national" class="form-select" name="national">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select id="directors" class="form-select director-input" name="directors[]" multiple>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="casts" class="form-control cast-input" name="casts[]" multiple>
