                                ...
                                @foreach($movieGenres as $value)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="#editModal" class="text-secondary font-weight-bold text-xs"
                                               data-toggle="tooltip" data-bs-target="#editModal{!! $value['id'] !!}"
                                        ...
                                        <td class="align-middle">
                                            <a href="javascript:void(0)"
                                               data-url="{{ url('admin/ajax/delete_movie_genres', $value['id'] ) }}"
                                               class="text-secondary font-weight-bold text-xs delete-genres"
                                               data-toggle="tooltip">
                                                Delete
                                            </a>
                                        </td>
