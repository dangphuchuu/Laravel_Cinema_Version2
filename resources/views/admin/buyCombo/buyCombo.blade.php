        ...
        <div class="card-body pt-2">
            <div class="row">
                ...
                <div class="col-12">
                    ...
                    <div class="progress" role="progressbar" aria-label="Example 1px high" aria-valuenow="10" aria-valuemin="0" aria-valuemax="30" style="height: 2px">
                    ...
                    <div id="mainTicket">
                        ...
                        <div id="Combos" class="mt-5 collapse show" data-bs-parent="#mainTicket">
                            ...
                            <div class="row g-2 mt-2 row-cols-2" data-bs-parent="#mainContent">
                                ...
                                <!-- Combo -->
                                <div class="col">
                                    <div class="card px-0 overflow-hidden" id="Combo_{{$combo->id}}" style="background: #f5f5f5">
                                        <div class="row g-0">
                                            <div class="col-lg-4 col-12">
                                                @if(strstr($combo->image,"https") == "")
                                                <img class="img-fluid w-100" alt="..." style="max-height: 361px; max-width: 241px" src="https://res.cloudinary.com/{{ $cloud_name }}/image/upload/{{ $combo->image }}.jpg">
                                                @else
                                                <img class="img-fluid w-100" alt="..." style="max-height: 361px; max-width: 241px" src="{{ $combo->image }}">
                                                @endif
                                            </div>
                                            <div class="col-lg-8 col-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="input-group">
                                                        <button class="btn mb-0 minus_combo disabled" onclick="minusCombo({{$combo->id}}, {{$combo->price}}, '{{ $combo->name }}')">
                                                            <i class="fa-solid fa-circle-minus"></i>
                                                        </button>
                                                        <input type="number" class="form-control input_combo ps-3" name="combo[{{$combo->id}}]" value="0" readonly min="0" style="max-width: 80px" aria-label="">
                                                        <button class="btn mb-0 plus_combo" onclick="plusCombo({{$combo->id}}, {{$combo->price}}, '{{ $combo->name }}')">
                                ...
                                <!-- Foods -->
                                <div class="col">
                                    <div class="card px-0 overflow-hidden" id="Food_{{$food->id}}" style="background: #f5f5f5">
                                        <div class="row g-0">
                                            <div class="col-lg-4 col-12">
                                                @if(strstr($food->image,"https") == "")
                                                <img class="img-fluid w-100" alt="..." style="max-height: 361px; max-width: 241px" src="https://res.cloudinary.com/{{ $cloud_name }}/image/upload/{{ $food->image }}.jpg">
                                                @else
                                                <img class="img-fluid w-100" alt="..." style="max-height: 361px; max-width: 241px" src="{{ $food->image }}">
                                                @endif
                                            </div>
                                            <div class="col-lg-8 col-12">
                                                <div class="card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="input-group">
                                                        <button class="btn mb-0 minus_food disabled" onclick="minusFood({{$food->id}}, {{$food->price}}, '{{ $food->name }}')">
                                                            <i class="fa-solid fa-circle-minus"></i>
                                                        </button>
                                                        <input type="number" class="form-control input_food ps-3" name="food[{{$food->id}}]" value="0" readonly min="0" style="max-width: 80px" aria-label="">
                                                        <button class="btn mb-0 plus_food" onclick="plusFood({{$food->id}}, {{$food->price}}, '{{ $food->name }}')">
                                                            <i class="fa-solid fa-circle-plus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                ...
                                <button class="btn btn-warning mx-2 text-decoration-underline text-center
                                    btn_next disabled" onclick="comboNext()" aria-controls="Payment" aria-expanded="false" data-bs-toggle="collapse" data-bs-target="#Payment">@lang('lang.next') <i class="fa-solid fa-angle-right"></i></button>
                            </div>
                        </div>
                        ...
                        <div id="Payment" class="mt-5 collapse" data-bs-parent="#mainTicket">
                            ...
                            <form id="paymentForm" action="admin/buyTicket/createPayment" method="post">
                                        ...
                                        <div class="col">
                                            <div class="bg-light p-4" id="bankCode">
                                                <div class="form-check mb-3">
                                                    ...
                                                    <label for="bankCode1" class="custom-control-label btn btn-outline-primary fw-semibold fs-4 w-100 text-start
                                                               text-dark">
                                                ...
                                                <div class="form-check mb-3">
                                                    <input id="bankCode4" class="btn-check" type="radio" name="bankCode" value="MONEY" aria-label="" checked>
                                                    <label for="bankCode4" class="custom-control-label btn btn-outline-primary fw-semibold fs-4 w-100
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <button type="button" class="btn btn-warning mx-2 text-decoration-underline text-center" onclick="paymentBack()" aria-expanded="true" data-bs-toggle="collapse" data-bs-target="#Combos">
                                        <i class="fa-solid fa-angle-left"></i> @lang('lang.previous')
                                    </button>
                                    <button type="button" onclick="paymentNext()" class="btn btn-warning mx-2 text-decoration-underline text-uppercase text-center">
...
<button id="btn_money" type="button" class="btn bg-gradient-primary d-none" data-bs-backdrop="static" data-bs-keyboard="false" data-bs-toggle="modal" data-bs-target="#handleMoney">
</button>
