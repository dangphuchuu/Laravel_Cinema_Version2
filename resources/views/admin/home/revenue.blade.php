                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        ...
                                        <h6 class="text-sm mb-0">SHAZAM!</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Movie:</p>
                                        <h6 class="text-sm mb-0">The Flash</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Movie:</p>
                                        <h6 class="text-sm mb-0">SpiderMan</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        ...
                                        <h6 class="text-sm mb-0">Movie cinema nguyễn trãi</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Cinema:</p>
                                        <h6 class="text-sm mb-0">Movie cinema quận 8</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="w-30">
                                <div class="d-flex px-2 py-1 align-items-center">
                                    <div class="ms-4">
                                        <p class="text-xs font-weight-bold mb-0">Cinema:</p>
                                        <h6 class="text-sm mb-0">Movie cinema quận 10</h6>
                                    </div>
                                </div>
                            </td>
                            <td>
