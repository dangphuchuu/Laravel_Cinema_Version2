                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="name" type="text" value="" name="name" placeholder="@lang('lang.type') @lang('lang.name')">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="code" class="form-control-label">@lang('lang.code')</label>
                                    <input class="form-control" id="code" type="text" value="" name="code" placeholder="@lang('lang.type') @lang('lang.code')">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="percent" class="form-control-label">@lang('lang.percent')</label>
                                    <input class="form-control" id="percent" type="number" value="" name="percent" placeholder="@lang('lang.type') @lang('lang.percent')">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
