                                    ...
                                    <div class="col-12">
                                        <div class="card mb-4 bg-body-tertiary">
                                            ...
                                            <div class="card-body px-0 pt-0 pb-2">
                                                {{--Giá vé--}}
                                                <div class="d-flex container my-4 justify-content-center text-nowrap overflow-x-auto">
                                                    <ul class="list-group bg-body-tertiary list-group-horizontal">
                        ...
                        <div id="Combos" class="mt-5 collapse" data-bs-parent="#mainTicket">
                            ...
                            <div class="row g-2 mt-2 row-cols-2" data-bs-parent="#mainContent">
                                @foreach($combos as $combo)
                                    <!-- Combo -->
                                    <div class="col">
                                        <div class="card px-0 overflow-hidden bg-danger-subtle" id="Combo_{{$combo->id}}">
                                            <div class="row g-0">
                                                ...
                                                <div class="col-lg-8 col-12">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text">@lang('lang.price'): <span class="fw-bold">{{ number_format($combo->price) }} đ</span></p>
                                                    </div>
                                                    <div class="card-body input_combo_block">
                                                        <div class="input-group">
                                                            <button class="btn minus_combo border-dark rounded-start-circle disabled"
                                                            ...
                                                            <button class="btn plus_combo border-dark rounded-end-circle"
