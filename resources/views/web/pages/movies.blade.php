...
<section class="container-lg clearfix">
    ...
    <div class="mt-5" id="Movies">
        <ul class="nav justify-content-start mb-4">
            <li class="nav-item">
                <button class="h5 nav-link link-warning active fw-bold border-bottom border-2 border-warning" aria-expanded="true" data-bs-toggle="collapse" data-bs-target="#phimdangchieu" disabled>
                    Phim đang chiếu
                </button>
            </li>
            <li class="vr mx-5"></li>
            <li class="nav-item me-auto">
                <button class="h5 nav-link link-secondary" aria-expanded="false" data-bs-toggle="collapse" data-bs-target="#phimsapchieu">
                    Phim sắp chiếu
                </button>
            </li>
            ...
            <div class="form-group ms-2">
                ...
                <select id="cast" name="director" class="form-select dropdown">
